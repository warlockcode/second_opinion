          ...
          body: Column(
            ...
            children: [
              Padding(
                ...
                child: Center(child: Text("Please Choose A category",style: TextStyle(color: Colors.white,fontSize: 26,fontWeight: FontWeight.bold),)),
              ),
                  ...
                  child: ListView.builder(
                      ...
                      itemBuilder: (context, index) {
                        return Padding(
                          ...
                          child: Card(
                            color: index%2==0?Colors.orange.shade400:Colors.yellow,
